...
export function User(props) {
    ...
    const mobaMap = 
        <svg width="357" height="312" viewBox="0 0 357 312" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
            <path d="M 32 141.500 C 32 201.725, 32.221 251, 32.492 251 C 32.762 251, 54.250 233.408, 80.242 211.906 C 163.783 142.797, 188.526 122.336, 239 80.629 C 266.225 58.132, 290.525 37.990, 293 35.869 L 297.500 32.013 164.750 32.006 L 32 32 32 141.500 M 221.500 146.031 C 164.850 192.868, 105.340 242.060, 89.255 255.345 L 60.011 279.500 192.168 279.754 C 264.855 279.893, 324.480 279.854, 324.667 279.666 C 324.855 279.478, 324.894 230.173, 324.754 170.098 L 324.500 60.872 221.500 146.031" stroke="none" fill="#548434" fill-rule="evenodd"/><path d="M -0 156.003 L -0 312.005 178.750 311.753 L 357.500 311.500 357.753 155.750 L 358.006 0 179.003 0 L 0 0 -0 156.003 M 0.488 156.500 C 0.488 242.300, 0.606 277.252, 0.750 234.171 C 0.894 191.091, 0.894 120.891, 0.750 78.171 C 0.606 35.452, 0.488 70.700, 0.488 156.500 M 32 141.500 C 32 201.725, 32.221 251, 32.492 251 C 32.762 251, 54.250 233.408, 80.242 211.906 C 163.783 142.797, 188.526 122.336, 239 80.629 C 266.225 58.132, 290.525 37.990, 293 35.869 L 297.500 32.013 164.750 32.006 L 32 32 32 141.500 M 221.500 146.031 C 164.850 192.868, 105.340 242.060, 89.255 255.345 L 60.011 279.500 192.168 279.754 C 264.855 279.893, 324.480 279.854, 324.667 279.666 C 324.855 279.478, 324.894 230.173, 324.754 170.098 L 324.500 60.872 221.500 146.031" stroke="none" fill="#fbe39b" fill-rule="evenodd"/>
            <circle id='tower_6_blue' cx="28.5" cy="285.5" r="25.5" fill="#3B88C0" />
            <circle id='tower_6_red' cx="327.5" cy="28.5" r="25.5" fill="#C03B3B" />
            <circle id='tower_4_blue' cx="16" cy="156" r="13" fill="#3B88C0" />
            <circle id='tower_1_blue' cx="16" cy="51" r="13" fill="#3B88C0" />
            <circle id='tower_2_blue' cx="143" cy="185" r="13" fill="#3B88C0" />
            <circle id='tower_5_blue' cx="172" cy="295" r="13" fill="#3B88C0" />
            <circle id='tower_3_blue' cx="299" cy="295" r="13" fill="#3B88C0" />
            <circle id='tower_4_red' cx="185" cy="16" r="13" fill="#C03B3B" />
            <circle id='tower_1_red' cx="51" cy="16" r="13" fill="#C03B3B" />
            <circle id='tower_2_red' cx="233" cy="113" r="13" fill="#C03B3B" />
            <circle id='tower_5_red' cx="341" cy="158" r="13" fill="#C03B3B" />
            <circle id='tower_3_red' cx="341" cy="259" r="13" fill="#C03B3B" />
            <defs>
    ...
    return (
        <div className={style.container}>
            <div className={style.nav_down} onClick={handleLogout}>
